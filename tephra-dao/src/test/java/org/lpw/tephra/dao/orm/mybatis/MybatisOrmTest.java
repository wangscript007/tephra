...
public class MybatisOrmTest extends DaoTestSupport {
    ...
    public void crudByMapper() {
        while (Calendar.getInstance().get(Calendar.SECOND) > 30)
        ...
        model1.setDatecol(new Date(System.currentTimeMillis() - TimeUnit.Day.getTime()));
        model1.setTimecol(new Timestamp(System.currentTimeMillis() - TimeUnit.Hour.getTime()));
        ...
        Assert.assertEquals(converter.toString(new Date(System.currentTimeMillis() - TimeUnit.Day.getTime())), converter.toString(model2.getDatecol()));
        Assert.assertEquals(converter.toString(new Timestamp(System.currentTimeMillis() - TimeUnit.Hour.getTime())), converter.toString(model2.getTimecol()));

        TestModel model3 = new TestModel();
        model3.setId(model1.getId());
        model3.setName("new name");
        model3.setDatecol(new Date(System.currentTimeMillis() - 3 * TimeUnit.Day.getTime()));
        model3.setTimecol(new Timestamp(System.currentTimeMillis() - 3 * TimeUnit.Hour.getTime()));
        ...
        Assert.assertEquals(converter.toString(new Date(System.currentTimeMillis() - 3 * TimeUnit.Day.getTime())), converter.toString(model4.getDatecol()));
        Assert.assertEquals(converter.toString(new Timestamp(System.currentTimeMillis() - 3 * TimeUnit.Hour.getTime())), converter.toString(model4.getTimecol()));
        ...
        for (int i = 0; i < 10; i++) {
            ...
            model.setDatecol(new Date(System.currentTimeMillis() - i * TimeUnit.Day.getTime()));
            model.setTimecol(new Timestamp(System.currentTimeMillis() - i * TimeUnit.Hour.getTime()));
    ...
    private void checkList(List<TestModel> list) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            Assert.assertEquals(converter.toString(new Date(System.currentTimeMillis() - i * TimeUnit.Day.getTime())), converter.toString(model.getDatecol()));
            Assert.assertEquals(converter.toString(new Timestamp(System.currentTimeMillis() - i * TimeUnit.Hour.getTime())), converter.toString(model.getTimecol()));
        }
    }
}
